...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Determines if one rectangle is bigger of equal to the other

        Args:
            rect_1 (Rectangle): 1st rectangle to compare
            rect_2 (Rectangle): 2nd rectangle to compare
        ...
        Returns:
            The biggest rectangle based on area or rect_1 if both have the same
            area value
        """
